...
#include <stdio.h>
	...
	#endif
//LCD pins mapping
#define LCD_RS_PIN			RA4
#define LCD_RW_PIN			RA5
#define LCD_EN_PIN			RE0
#define LCD_DATA4_PIN		RA0
#define LCD_DATA5_PIN		RA1
#define LCD_DATA6_PIN		RA2
#define LCD_DATA7_PIN		RA3
...
void lcd_delay_ms(unsigned int time);
void lcd_wait_busy();
