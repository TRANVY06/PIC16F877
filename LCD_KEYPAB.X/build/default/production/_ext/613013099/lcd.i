...
void lcd_init()
{
    ...
    lcd_wait_busy();
    lcd_command(0b00001101 & 0b00001110);
    lcd_wait_busy();
...
void lcd_custom_char(char row, char col, char add_cgram, const char custom_char[])
{
    ...
    lcd_command(0b01000000 | add_cgram_cell);
