	...
	; Compiler options:
	;
	; -q --opt=none --chip=16f887 \
	; -Mdist/default/production/test.X.production.map \
	; -DXPRJ_default=default -L--defsym=__MPLAB_BUILD=1 \
	; --dfp=C:/Program Files/Microchip/MPLABX/v6.25/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8 \
	...
	; -otest.X.production.elf --objdir=dist/default/production \
	; --outdir=dist/default/production build/default/production/test.p1 \
	; -L--fixupoverflow=error --rors --icl=auto --callgraph=none \
